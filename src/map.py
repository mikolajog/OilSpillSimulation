...
class Map(object):
    ...
    #    self.simulationArray[x_coord][y_coord].oil_points = self.split_to_oil_points(total_weight,(x_coord,y_coord))

    # przyjmuję że całą ropę dyskretuzyje za pomocą 20 równych porcji
    # def split_to_oil_points(self, total_weight, start_coords):
    #     oil_points_list = []
    #
    #     for i in range(20):
    #         oil_points_list.append(Oil_point(total_weight / 20, start_coords))
    #
